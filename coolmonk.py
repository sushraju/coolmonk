...
education = [
        ['Masters in Computer Science & Applications', 'Bharathiyar University'],
        ['BSc in Computer Science', 'Bharathiyar University']
        ]

interests = ['jazz','travel','tech','wine','animals']

skills = [
        ['distributed systems in java and go', '80%'],
        ['python, perl and shell', '85%'],
        ['kubernetes, docker, envoy', '85%'],
        ['security, networking', '80%'],
        ['linux, solaris', '85%'],
        ['aws, gcp, oci', '80%'],
        ['vault, terraform', '85%'],
        ['kafka, flink, zookeeper', '75%'],
        ['redis, solr and elk', '70%'],
        ['akamai and cloudflare', '80%'],
        ['git, mercurial', '80%']
        ]
...
experience = [
        ['Platform & Infrastructure',
            'Apr 2021 - present',
            'Mux, San Francisco',
            '<p><li>Built and scaled the different parts of the core platform upon which the video and video analytics products are built. <li>Worked on scaling the platform to support analytics for some of the largest live streaming sporting events.</p>'
        ],
...
resume_data = {
    'site_title' : 'CoolMonk',
    'name' : 'Suresh Raju',
    'tagline' : 'Scalable infrastructure & Site reliability',
