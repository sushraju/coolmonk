...
def news():
    ...
    sources_list = ['wired', 'the-verge', 'hacker-news', 'cnn', 'bbc-news', 'ars-technica', 'engadget', 'espn',
                    'espn-cric'
                    '-info',
                    'national-geographic', 'new-york-magazine', 'new-scientist', 'the-huffington-post', 'the-next-web',
                    'the-washington-post', 'the-hindu']

    sources = sources_list[random.randint(0, len(sources_list) - 1)] + ',' + sources_list[random.randint(0, len(sources_list) - 1)] + ',' + sources_list[random.randint(0, len(sources_list) - 1)]
